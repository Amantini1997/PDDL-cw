...
directory_path = r"C:\Users\Akshat\Desktop\OMEGA\STUDIES\2020 - 2021\6CCS3AIP\Coursework\Data"

df = pd.DataFrame(columns=['Instance', 'Heuristic', 'Plan Length', 'Plan Cost', 'States Expanded', 'States Reopened', 'States Evaluated', 'Evaluations', 'States Generated', 'Dead Ends', 'States Expanded ULJ', 'States Reopened ULJ', 'States Evaluated ULJ', 'States Generated ULJ', 'Registered States', 'Hash Set Load Factor', 'Hash Set Resizes', 'Search Time (s)', 'Total Time (s)', 'Peak Memory (KB)'])
...
for file in files:
    ...
    heuristic = "Additive" if re.split('-|\.', file)[4] == "add" else "Causal Graph"
    ...
    df.loc[len(df)] = [instance, heuristic, plan_length, plan_cost, states_expanded, states_reopened, states_evaluated, evaluations, states_generated, dead_ends, states_expanded_ulj, states_reopened_ulj, states_evaluated_ulj, states_generated_ulj, registered_states, hash_set_load_factor, hash_set_resizes, search_time, total_time, peak_memory]
